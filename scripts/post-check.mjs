...
try {
  ...
  await page.getByRole('heading', { name: 'Your starting point is set.' }).waitFor()
  ...
  await page.getByRole('heading', { name: 'First, tell us about you.' }).waitFor()
  ...
  await noJs.getByRole('heading', { name: 'Your starting point is set.' }).waitFor()
