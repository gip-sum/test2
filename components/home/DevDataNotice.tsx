...
export function DevDataNotice() {
  ...
  return (
    <div className="border-b border-warn-600/25 bg-warn-100">
      <p className="mx-auto max-w-[1320px] px-4 py-2 text-caption text-warn-600 lg:px-8">
        <strong className="font-semibold">Development build.</strong> Listings shown are seeded
        sample data, not real properties. No seller, price or availability here is genuine.
      </p>
    </div>
  )
}
